...
from google.cloud.texttospeech_v1beta1.services.text_to_speech_long_audio_synthesize import TextToSpeechLongAudioSynthesizeAsyncClient
...
from google.cloud.texttospeech_v1beta1.services.text_to_speech_long_audio_synthesize import transports
...
def test_text_to_speech_long_audio_synthesize_client_client_options_from_dict():
    with mock.patch('google.cloud.texttospeech_v1beta1.services.text_to_speech_long_audio_synthesize.transports.TextToSpeechLongAudioSynthesizeGrpcTransport.__init__') as grpc_transport:
...
def test_synthesize_long_audio_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("input", "audioConfig", )))
...
def test_text_to_speech_long_audio_synthesize_base_transport():
    ...
    with mock.patch('google.cloud.texttospeech_v1beta1.services.text_to_speech_long_audio_synthesize.transports.TextToSpeechLongAudioSynthesizeTransport.__init__') as Transport:
...
def test_text_to_speech_long_audio_synthesize_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.texttospeech_v1beta1.services.text_to_speech_long_audio_synthesize.transports.TextToSpeechLongAudioSynthesizeTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_text_to_speech_long_audio_synthesize_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.texttospeech_v1beta1.services.text_to_speech_long_audio_synthesize.transports.TextToSpeechLongAudioSynthesizeTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.TextToSpeechLongAudioSynthesizeTransport()
        adc.assert_called_once()
