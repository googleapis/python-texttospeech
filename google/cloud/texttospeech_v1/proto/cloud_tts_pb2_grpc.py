...
from google.cloud.texttospeech_v1.proto import (
    cloud_tts_pb2 as google_dot_cloud_dot_texttospeech__v1_dot_proto_dot_cloud__tts__pb2,
)
...
def add_TextToSpeechServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "ListVoices": grpc.unary_unary_rpc_method_handler(
            servicer.ListVoices,
            request_deserializer=google_dot_cloud_dot_texttospeech__v1_dot_proto_dot_cloud__tts__pb2.ListVoicesRequest.FromString,
            response_serializer=google_dot_cloud_dot_texttospeech__v1_dot_proto_dot_cloud__tts__pb2.ListVoicesResponse.SerializeToString,
        ),
        "SynthesizeSpeech": grpc.unary_unary_rpc_method_handler(
            servicer.SynthesizeSpeech,
            request_deserializer=google_dot_cloud_dot_texttospeech__v1_dot_proto_dot_cloud__tts__pb2.SynthesizeSpeechRequest.FromString,
            response_serializer=google_dot_cloud_dot_texttospeech__v1_dot_proto_dot_cloud__tts__pb2.SynthesizeSpeechResponse.SerializeToString,
        ),
    }
